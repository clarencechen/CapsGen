...
def load_data():
	...
	x_train = dataset._parse_NORB_dat_file(dataset.dataset_files['train']['dat'])
	y_train = np.eye(5)[np.repeat(dataset._parse_NORB_cat_file(dataset.dataset_files['train']['cat']), 2)]
	x_test = dataset._parse_NORB_dat_file(dataset.dataset_files['test']['dat'])
	y_test = np.eye(5)[np.repeat(dataset._parse_NORB_cat_file(dataset.dataset_files['test']['cat']), 2)]
